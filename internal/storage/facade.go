...
func (s storageFacade) ReturnOrder(ctx context.Context, order *models.Order) error {
...
func (s storageFacade) RefundOrder(ctx context.Context, order *models.Order, userId uint) error {
	return s.txManager.RunReadCommited(ctx, func(ctxTx context.Context) error {
