...
func request_PupService_WorkerNum_0(ctx context.Context, marshaler runtime.Marshaler, client PupServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq WorkersNumRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.WorkerNum(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_PupService_WorkerNum_0(ctx context.Context, marshaler runtime.Marshaler, server PupServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq WorkersNumRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.WorkerNum(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterPupServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PupServiceServer) error {
	...
	mux.Handle("PUT", pattern_PupService_WorkerNum_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/pup_service.PupService/WorkerNum", runtime.WithHTTPPathPattern("/WorkerNum"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_PupService_WorkerNum_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_PupService_WorkerNum_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterPupServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PupServiceClient) error {
	...
	mux.Handle("PUT", pattern_PupService_WorkerNum_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/pup_service.PupService/WorkerNum", runtime.WithHTTPPathPattern("/WorkerNum"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_PupService_WorkerNum_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_PupService_WorkerNum_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"WorkerNum"}, ""))
)
...
var (
	...
	forward_PupService_WorkerNum_0 = runtime.ForwardResponseMessage
)
