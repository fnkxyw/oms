...
// Validate checks the field values on WorkersNumRequest with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *WorkersNumRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on WorkersNumRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// WorkersNumRequestMultiError, or nil if none found.
func (m *WorkersNumRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *WorkersNumRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if val := m.GetNum(); val <= 0 || val >= 100 {
		err := WorkersNumRequestValidationError{
			field:  "Num",
	...
	if len(errors) > 0 {
		return WorkersNumRequestMultiError(errors)
	}

	return nil
}

// WorkersNumRequestMultiError is an error wrapping multiple validation errors
// returned by WorkersNumRequest.ValidateAll() if the designated constraints
// aren't met.
type WorkersNumRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m WorkersNumRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m WorkersNumRequestMultiError) AllErrors() []error { return m }

// WorkersNumRequestValidationError is the validation error returned by
// WorkersNumRequest.Validate if the designated constraints aren't met.
type WorkersNumRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e WorkersNumRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e WorkersNumRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e WorkersNumRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e WorkersNumRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e WorkersNumRequestValidationError) ErrorName() string {
	return "WorkersNumRequestValidationError"
}

// Error satisfies the builtin error interface
func (e WorkersNumRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sWorkersNumRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = WorkersNumRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = WorkersNumRequestValidationError{}

// Validate checks the field values on WorkersNumResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *WorkersNumResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on WorkersNumResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// WorkersNumResponseMultiError, or nil if none found.
func (m *WorkersNumResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *WorkersNumResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return WorkersNumResponseMultiError(errors)
	}

	return nil
}

// WorkersNumResponseMultiError is an error wrapping multiple validation errors
// returned by WorkersNumResponse.ValidateAll() if the designated constraints
// aren't met.
type WorkersNumResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m WorkersNumResponseMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m WorkersNumResponseMultiError) AllErrors() []error { return m }

// WorkersNumResponseValidationError is the validation error returned by
// WorkersNumResponse.Validate if the designated constraints aren't met.
type WorkersNumResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e WorkersNumResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e WorkersNumResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e WorkersNumResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e WorkersNumResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e WorkersNumResponseValidationError) ErrorName() string {
	return "WorkersNumResponseValidationError"
}

// Error satisfies the builtin error interface
func (e WorkersNumResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sWorkersNumResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = WorkersNumResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = WorkersNumResponseValidationError{}
